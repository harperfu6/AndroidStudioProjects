...
class AmphibianListAdapter(val clickListener: AmphibianListener) : ListAdapter<Amphibian, AmphibianListAdapter.AmphibianViewHolder>(DiffCallback) {
    ...
    class AmphibianViewHolder(var binding: ListViewItemBinding): RecyclerView.ViewHolder(binding.root) {
        fun bind(clickListener: AmphibianListener, amphibian: Amphibian) {
            ...
            binding.executePendingBindings() // layoutの高さがwrap_contentのときこれを呼ばないとかくつく（https://android.gcreate.jp/358/）
        }
    }
